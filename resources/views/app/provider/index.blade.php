                ...
                @foreach ($providers as $provider)
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="{{ route('app.provider.delete', $provider->id) }}" method="POST" style="display:inline-block;">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-sm" onclick="return confirm('Tem certeza que deseja excluir este fornecedor?')">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
